...
description: An app that allows users to securely sign up, login, see everyone's messages, create a new message and log out.
pubDate: 2023-08-21T00:00:00Z
imgSrc: '/assets/images/chitter-signup-1.png'
imgAlt: 'Chitter App Signup page'
---
